...
namespace Persistance.Migrations
{
    ...
    [Migration("20230903200933_CompanyBankIbanAccount")]
    partial class CompanyBankIbanAccount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Concrete.CompanyBankIbanAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CompanyBankIbanAccounts", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Concrete.CompanyBankIbanAccount", b =>
                {
                    b.HasOne("Domain.Entities.Concrete.BankIbanAccount", "BankIbanAccount")
                        .WithMany()
                        .HasForeignKey("BankIbanAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
